...
| --- | ---: | --- |
| AI and developer workflow | 60% | How AI fits into a real coding workflow |
| Mechanical keyboards | 40% | Choosing a keyboard layout or switch type |

## Selection criteria

An idea should meet at least three of these criteria:

- Solves a specific viewer question
- Fits one of the current pillars
