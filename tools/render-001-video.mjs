...
const preview = path.join(root, "assets", "001-keyboard-layout", "animatic-preview.html");
const frameDir = path.join(root, "exports", "001-keyboard-layout", "frames");
const outputDir = path.dirname(frameDir);
const output = path.join(outputDir, "keyboard-layout-visual-cut-v0.mp4");
const durations = [35, 40, 50, 55, 55, 60, 65, 65, 100, 30];
...
const lastFrame = path.join(frameDir, "10.png").replaceAll("\\", "/");
