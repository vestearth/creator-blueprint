...
- Do not add creator work to `AI-office-agency`.

## Working principles

1. Read the channel files and the active workflow before changing content.
2. Treat AI as a production assistant; retain a clear human editorial angle.
3. Record sources and distinguish sourced facts from opinion or experience.
4. Do not use media, music, voices, brands, or likenesses without a documented
   usage basis.
5. Do not optimize for publishing volume at the expense of originality.
6. Prefer a small manual workflow before adding automation or dependencies.
7. Keep one content item in one `content/<id>-<slug>/` directory.
8. Promote lessons only after evidence from actual production or analytics.
