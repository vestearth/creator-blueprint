...
| P-001 | Short 97-key product example | Remote image embedded at render time from [AJAZZ AK980](https://ajazzstore.com/products/ajazz-ak980) | Official manufacturer product image; specification basis C-009/C-012 | Third-party editorial reference | Used only in Short comparison card; model name and 97-key count shown on-screen |
| P-002 | Short 99-key product example | Remote image embedded at render time from [EPOMAKER x AULA F99](https://epomaker.com/products/epomaker-aula-f99) | Official manufacturer product image; specification basis C-009/C-012 | Third-party editorial reference | Used only in Short comparison card; model name and 99-key count shown on-screen |
